...
### Jan 7
*Estimated Total Time: 1 hours
* Goal 1: Fix bug in table display
   * Updated table display in approve.html
   * Fixed column heading issue and timestamping
* Goal 2: Add download button
   * Edited upload.html to include a download featured
   * Rewrote flaskApp.py router to support feature

### Jan 5
*Estimated Total Time: 2 hours
* Goal 1: Fix bug in requests tab
   * Updated the router
   * Standardized the requests tab formatting
* Goal 2: Fix bug in cadet data disply
   * Cadet data would quick every other column
   * Rewrote the excel parser for data display
   * standardixed column heading (removed spaces and illegal characters)
* Goal 3: Add reset button in requests
   * approve.html now has a RESET REQUESTS button
   * Updated the router with new feature
...
# Bugs
* add method for editing excel sheet in inventory.html
* create email system for cadets for semester uniform updates
